...
public class SchemaCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = OrmDiagramUpdater.getSchema_1000SemanticChildren(
	...
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(Package.eINSTANCE
					.getSchema_SchemaShapes());
		}
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
					.hasNext();) {
				OrmLinkDescriptor nextLinkDescriptor = (OrmLinkDescriptor) linkDescriptorsIterator
						.next();
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final OrmLinkDescriptor nextLinkDescriptor = (OrmLinkDescriptor) linkDescriptorsIterator
					.next();
