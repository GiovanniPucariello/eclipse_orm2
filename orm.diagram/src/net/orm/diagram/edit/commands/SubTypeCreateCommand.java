...
public class SubTypeCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public SubTypeCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OrmBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateSubType_4003(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		SubType newElement = Factory.eINSTANCE.createSubType();
		getContainer().getSubTypes().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(SubType newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
