 ...
 * @generated
 */
public class EntityRoleCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EntityRoleCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return OrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateEntityRole_4001(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		EntityRole newElement = Factory.eINSTANCE.createEntityRole();
		getContainer().getEntityRoles().add(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(EntityRole newElement, IProgressMonitor monitor,
			IAdaptable info) throws ExecutionException {
