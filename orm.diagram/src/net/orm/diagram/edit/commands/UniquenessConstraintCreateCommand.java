 ...
 * @generated
 */
public class UniquenessConstraintCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final Predicate container;

	/**
	 * @generated
	 */
	public UniquenessConstraintCreateCommand(CreateRelationshipRequest request,
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		UniquenessConstraint newElement = Factory.eINSTANCE
				.createUniquenessConstraint();
		getContainer().getConstraints().add(newElement);
		newElement.getRoles().add(getSource());
	 ...
	 * @generated
	 */
	protected void doConfigure(UniquenessConstraint newElement,
	 ...
	 * @generated
	 */
	private static Predicate deduceContainer(EObject source, EObject target) {
