 ...
 * @generated
 */
public class EntityRoleReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EntityRoleReorientCommand(ReorientRelationshipRequest request) {
	...
	protected boolean canReorientTarget() {
		...
		Entity source = getLink().getEntity();
		if (!(getLink().eContainer() instanceof Schema)) {
			return false;
		}
		Schema container = (Schema) getLink().eContainer();
