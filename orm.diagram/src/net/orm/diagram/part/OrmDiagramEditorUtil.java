 ...
 * @generated
 */
public class OrmDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.OrmDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.OrmDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = OrmDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.OrmDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.OrmDiagramEditorUtil_CreateDiagramCommandLabel,
			...
			protected CommandResult doExecuteWithResult(
				...
				try {
					modelResource
							.save(net.orm.diagram.part.OrmDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(net.orm.diagram.part.OrmDiagramEditorUtil
									.getSaveOptions());
	...
	private static Schema createInitialModel() {
		return Factory.eINSTANCE.createSchema();
	}
