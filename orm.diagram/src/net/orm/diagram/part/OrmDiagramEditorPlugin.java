 ...
 * @generated
 */
public class OrmDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "orm.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static OrmDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private OrmDocumentProvider documentProvider;
	 ...
	 * @generated
	 */
	public static OrmDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public OrmDocumentProvider getDocumentProvider() {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, OrmDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, OrmDiagramEditorPlugin.ID, IStatus.OK,
						message, throwable));
