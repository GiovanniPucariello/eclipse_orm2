 ...
 * <ul>
 *   <li>{@link net.orm.impl.EntityImpl#isOccursElseWhere <em>Occurs Else Where</em>}</li>
 *   <li>{@link net.orm.impl.EntityImpl#isIsIndependent <em>Is Independent</em>}</li>
 *   <li>{@link net.orm.impl.EntityImpl#getReferenceScheme <em>Reference Scheme</em>}</li>
 *   <li>{@link net.orm.impl.EntityImpl#getName <em>Name</em>}</li>
 *   <li>{@link net.orm.impl.EntityImpl#isIsValueType <em>Is Value Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EntityImpl extends SchemaShapeImpl implements Entity {
	/**
	...
	protected EClass eStaticClass() {
		return net.orm.Package.Literals.ENTITY;
	}
	...
	public void setOccursElseWhere(boolean newOccursElseWhere) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, net.orm.Package.ENTITY__OCCURS_ELSE_WHERE, oldOccursElseWhere, occursElseWhere));
	}
	...
	public void setIsIndependent(boolean newIsIndependent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, net.orm.Package.ENTITY__IS_INDEPENDENT, oldIsIndependent, isIndependent));
	}
	...
	public ReferenceScheme getReferenceScheme() {
		if (referenceScheme != null && referenceScheme.eIsProxy()) {
			...
			if (referenceScheme != oldReferenceScheme) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, net.orm.Package.ENTITY__REFERENCE_SCHEME, oldReferenceScheme, referenceScheme));
			}
		}
	...
	public void setReferenceScheme(ReferenceScheme newReferenceScheme) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, net.orm.Package.ENTITY__REFERENCE_SCHEME, oldReferenceScheme, referenceScheme));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, net.orm.Package.ENTITY__NAME, oldName, name));
	}
	...
	public void setIsValueType(boolean newIsValueType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, net.orm.Package.ENTITY__IS_VALUE_TYPE, oldIsValueType, isValueType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case net.orm.Package.ENTITY__OCCURS_ELSE_WHERE:
				return isOccursElseWhere();
			case net.orm.Package.ENTITY__IS_INDEPENDENT:
				return isIsIndependent();
			case net.orm.Package.ENTITY__REFERENCE_SCHEME:
				if (resolve) return getReferenceScheme();
				return basicGetReferenceScheme();
			case net.orm.Package.ENTITY__NAME:
				return getName();
