 ...
 *   <li>{@link net.orm.Schema#getEntityRoles <em>Entity Roles</em>}</li>
...
public interface Schema extends EObject {
	...
	/**
	 * Returns the value of the '<em><b>Entity Roles</b></em>' containment reference list.
	 * The list contents are of type {@link net.orm.EntityRole}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Entity Roles</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Entity Roles</em>' containment reference list.
	 * @see net.orm.Package#getSchema_EntityRoles()
	 * @model containment="true"
	 * @generated
	 */
	EList<EntityRole> getEntityRoles();
